...
A Chrome extension that was designed to help protect Discord users from scams, phishing, malware, and malicious links during their time browsing Discord.

It is an automated service, running in the background of your browser and scanning links as they come up, without any manual action required on your part.
...
- Checks Links when they arrive as a message
- Highlights Suspected Links with **Red** color
- Operates in Chats, Servers, and the Discover page
- Even checks the content loaded after opening a channel

### 🧠 Scam Detection

This extension searches for typical scam characteristics, such as:

* Scamming through fake Nitro/giveaway
* Phishing
* Scams by referral links
* Fake free money
* Suspicious words/domains

Additionally, it performs the normalization of the text in order to identify simple ways of masking scam-related phrases, like `fr33 m0ney`.
